...
/// Icon Size
const double kExThinIconSize = 12.0;
const double kThinIconSize = 14.0;
const double kIconSize = 16.0;
const double kWideIconSize = 18.0;
const double kFatIconSize = 20;
